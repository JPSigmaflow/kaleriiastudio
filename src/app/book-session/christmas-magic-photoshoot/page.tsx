...
export default function ChristmasMagicBookingPage() {
  useEffect(() => {
    (async function () {
      try {
        const cal = await getCalApi({ namespace: "christmas-magic-photoshoot" } as { namespace: string });
        cal("ui", {
          theme: "light",
  ...
  return (
    <div className="bg-background min-h-screen pb-16">
      <div className="w-full">
        <Cal
          namespace="christmas-magic-photoshoot"
          calLink="kaleriiastudio/christmas-magic-photoshoot"
