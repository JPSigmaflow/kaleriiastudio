...
export default function BrandProductBookingPage() {
  useEffect(() => {
    (async function () {
      try {
        const cal = await getCalApi({ namespace: "brand-product-story-content" } as { namespace: string });
        cal("ui", {
          theme: "light",
  ...
  return (
    <div className="bg-background min-h-screen pb-16">
      <div className="w-full">
        <Cal
          namespace="brand-product-story-content"
          calLink="kaleriiastudio/brand-product-story-content"
