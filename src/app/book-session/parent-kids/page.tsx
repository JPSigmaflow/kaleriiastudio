...
export default function ParentKidsBookingPage() {
  useEffect(() => {
    (async function () {
      try {
        const cal = await getCalApi({ namespace: "parent-kids-photoshoot" } as { namespace: string });
        cal("ui", {
          theme: "light",
  ...
  return (
    <div className="bg-background min-h-screen pb-16">
      <div className="w-full">
        <Cal
          namespace="parent-kids-photoshoot"
          calLink="kaleriiastudio/parent-kids-photoshoot"
